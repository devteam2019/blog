					...
					<div class="card-body">
						<div id="table" class="table-editable">
							<span class="table-add float-right mb-3 mr-2">
								<a href="#!" @click="clickCreatePost" class="text-success">
									...
									<table class="table table-bordered table-responsive-md table-striped text-center">
										...
										<tr v-for="post in postsData">
											...
											<td class="pt-3-half" contenteditable="true">
												<label class="switch">
													<input style="width: 48px; height: 20px;" type="checkbox" @change="changePublic(post, $event)" :checked="post.public == 1 ? true : false">
													<span class="slider round"></span>
												</label>
											</td>
											<td>
												<span class="table-remove">
													<button type="button" class="btn btn-info btn-rounded btn-sm my-0" @click="clickEdit(post)">Conteúdo</button>
												</span>
											</td>
											<td>
												<span class="table-remove">
													<button type="button" class="btn btn-danger btn-rounded btn-sm my-0" @click="clickDelete(post)">Delete</button>
												</span>
											</td>
										</tr>
									</table>
		...
		<b-modal ref="myModalRef" size="lg" hide-footer title="Criar Artigo">
			<div class="d-block">
				...
				<b-form-group label="Título">
					<b-form-input type="text" v-model="post.title" placeholder="Título">
					</b-form-input>
				</b-form-group>

				<b-form-group label="SubTítulo">
					<b-form-input type="text" v-model="post.subTitle" placeholder="SubTítulo">
					</b-form-input>
				</b-form-group>

				<b-form-group label="Data">
					<b-form-input type="date" v-model="post.date" placeholder="Data">
					</b-form-input>
				</b-form-group>
